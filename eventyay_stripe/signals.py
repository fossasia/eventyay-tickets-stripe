        ...
        return [
            {
                ...
                "url": reverse(
                    "plugins:eventyay_stripe:settings.connect", kwargs={"organizer": request.organizer.slug}
                ),
                "parent": reverse("control:organizer.edit", kwargs={"organizer": request.organizer.slug}),
